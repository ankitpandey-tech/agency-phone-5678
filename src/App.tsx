...
export default function App() {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col justify-between font-sans leading-relaxed text-slate-800 antialiased" id="neviqai-app-pinnacle">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-45 p-3 flex shadow-2xl items-center justify-between" id="mobile-sticky-action-bar">
        <div className="text-left leading-tight pl-2">
          ...
          <span className="text-xs font-extrabold text-slate-900 font-sans tracking-tight">NeviqAI Receptionist</span>
        </div>
