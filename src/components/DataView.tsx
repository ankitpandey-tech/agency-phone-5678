        ...
        <div className="p-5 md:p-6 bg-blue-550/5 border border-blue-550/10 rounded-2xl space-y-4">
          ...
          <div className="text-xs text-slate-600 space-y-2 leading-relaxed">
            ...
            <ul className="list-disc pl-5 space-y-1 text-slate-500 text-[11px]">
              <li>
                <strong className="text-slate-700">Gmail Notifications:</strong> Powered via a simple server-side SMTP mailer or the Google Gmail API to immediately email you at <span className="text-blue-600 font-semibold underline">hello.neviqai@gmail.com</span> with all client details.
              </li>
              <li>
