        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-8 md:p-12 shadow-sm space-y-10">
          ...
          <div className="space-y-8 text-sm md:text-base text-slate-650 leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <p>
                By accessing, implementing, or otherwise using the NeviqAI software, services, or website ("Service"), you agree to be bound by these Terms & Conditions ("Terms"). If you do not agree to these Terms, you must immediately cease all use of our services.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p>
                NeviqAI provides cloud-hosted conversational voice receptionist systems using artificial intelligence to answer telephone lines, parse user questions, forward leads, and schedule appointments on connected calendars.
              </p>
              <p>
            ...
            <div className="space-y-3">
              ...
              <p>
                All conversational voice prompt frameworks, custom LLM routing architectures, natural language understanding designs, software structures, graphic interfaces, website elements, and documentation are the exclusive property of NeviqAI and our technology partners.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p>
                To the maximum extent permitted by applicable law in the USA, Canada, and Australia, NeviqAI shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues (including missed bookings, missed HVAC emergencies, calendar scheduling conflicts, or erroneous AI-caller interactions).
              </p>
              <p>
            ...
            <div className="space-y-3">
              ...
              <p>
                You may cancel your monthly NeviqAI subscription at any time inside your user billing dashboard or by emailing our customer support team. Cancellation will take effect at the end of the current billing cycle.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 bg-blue-50/50 border border-blue-100 rounded-2xl p-4 w-fit" id="terms-conditions-contact-card">
                ...
                <span className="font-semibold text-slate-900 text-sm">hello.neviqai@gmail.com</span>
              </div>
            </div>
