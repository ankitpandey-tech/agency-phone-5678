        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-8 md:p-12 shadow-sm space-y-10">
          ...
          <div className="space-y-8 text-sm md:text-base text-slate-650 leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <p>
                Because NeviqAI offers intangibles, immediate cloud telephony resources, dedicated virtual phone lines, custom model training, and custom setup engineering, we maintain a <strong>No Refund Policy</strong> on all active recurring monthly and annual subscription plans.
              </p>
            </div>
