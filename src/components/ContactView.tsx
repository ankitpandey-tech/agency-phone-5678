            ...
            {isSent ? (
              <div className="text-center py-12 space-y-4 my-auto h-full flex flex-col justify-center" id="contact-submit-success">
                ...
                <p className="text-xs text-slate-550 max-w-sm mx-auto leading-relaxed">
                  Thank you, <span className="font-semibold text-slate-800">{name}</span>. One of our NeviqAI SaaS Integration Specialists or our founder Ankit Pandey will get back to your query at <span className="font-semibold text-slate-800">{email}</span> in under 12 hours.
                </p>
                <div className="pt-4">
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="E.g. name@yourbusiness.com"
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all text-xs font-sans"
                    />
                  </div>
                  ...
                  <div className="space-y-2 col-span-1 md:col-span-2">
                    ...
                    <textarea
                      ...
                      placeholder="E.g. Looking to integrate NeviqAI with Housecall Pro dispatch software and require HIPAA-aligned safeguards. Can you assist with setup?"
              ...
              <div className="space-y-5" id="support-coord-links">
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="mailto:hello.neviqai@gmail.com" className="text-sm font-semibold text-white hover:text-green-400 hover:underline">
                      hello.neviqai@gmail.com
                    </a>
                  </div>
                </div>
