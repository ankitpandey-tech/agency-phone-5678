...
export default function DemoBookingView({ setCurrentPage }: DemoBookingViewProps) {
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    ...
    if (!businessName.trim()) {
      setFormError('Please enter your business or Business Name.');
      return;
    }
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4" id="demo-booking-header">
          ...
          <p className="text-slate-600 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
            Get an interactive sandbox phone number loaded with your home service business parameters. No obligation, 15-minute live review with our telephony experts.
          </p>
        </div>
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    ...
                    <div className="space-y-1.5">
                      <label className="font-bold text-slate-700 block">Business / Business Name *</label>
                      <input
                        type="text"
                        required
                        value={businessName}
                        onChange={(e) => setBusinessName(e.target.value)}
                        placeholder="E.g. Arctic Breeze HVAC LLC"
                        className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-blue-500 transition-all font-sans text-sm"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        ...
                        <option value="ServiceTitan">ServiceTitan / Housecall Pro</option>
