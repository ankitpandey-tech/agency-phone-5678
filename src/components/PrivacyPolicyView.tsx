        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-8 md:p-12 shadow-sm space-y-10">
          ...
          <div className="space-y-8 text-sm md:text-base text-slate-650 leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <p>
                NeviqAI ("we", "us", "our") values the privacy of our clients and their callers. This Privacy Policy explains how we collect, use, disclose, and safeguard personal information when our clients integrate our conversational AI phone reception systems into their businesses in the **United States, Canada, and Australia**.
              </p>
              <p>
              ...
              <div className="bg-slate-50 border border-slate-250/50 rounded-2xl p-5 space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-1">
                    We strictly comply with the Telephone Consumer Protection Act (TCPA) and California Consumer Privacy Act (CCPA/CPRA). For HVAC and plumbing companies, our systems can be configured to comply with strict data safeguards, maintaining strict business associate agreements (BAAs).
                  </p>
                </div>
                <div>
