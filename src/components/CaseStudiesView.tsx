...
export default function CaseStudiesView({ setCurrentPage }: CaseStudiesViewProps) {
  const caseStudies = [
    {
      title: "How Tom's Precision Electrician Swapped Voicemail for AI, Increasing Reviews by 300%",
      industry: "Electrician & Garage Stations",
      location: "Seattle, WA",
      metrics: [
      ...
      action: "We deployed NeviqAI's Growth system, configuring synthetic oil change quote rules, immediate diagnostic intakes booking, and automated SMS rating follow-ups scheduled 45 minutes after key handbacks.",
      quote: "\"Setting up NeviqAI took less than 3 days. Now, dirty hands and busy lifts never cost us business. Review volume went from 3 a month to 25+ average, making us the top local garage on Google Maps!\"",
      author: "Tom Sterling, Owner"
    },
    {
      title: "Arctic Breeze HVAC Reduced Missed Appointments by 80%",
      industry: "HVAC Servicess & Diagnostics Center",
      location: "Denver, CO",
      metrics: [
      ...
      action: "Configured NeviqAI's HIPAA-friendly triage logic, answers common patient check-in protocols, registers open doctor calendars slots directly, and dispatches questionnaire links over text.",
      quote: "\"Our dispatchers now focus strictly on field dispatches and emergency safety triages. The virtual receptionist secures high-priority emergency calls 24/7 without fail.\"",
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-12">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-4" id="case-studies-header">
          ...
          <p className="text-slate-600 text-base leading-relaxed">
            Real trade results and quantitative case studies demonstrating how local HVAC, Plumbing companies, and repair shops scale bookings and Google authority at minimal costs.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm" id={`steps-grid-${index}`}>
                ...
                <div className="space-y-2">
                  <h4 className="font-bold text-slate-900 flex items-center space-x-2">
                    ...
                    <span>The NeviqAI Action Plan:</span>
                  </h4>
        ...
        <div className="bg-slate-950 text-white rounded-3xl p-8 text-center space-y-6" id="studies-inline-cta">
          ...
          <p className="text-sm text-slate-400 max-w-xl mx-auto leading-relaxed">
            Register for our diagnostic demo call. We configure a custom testing number and outline a free automated follow-up blueprint for your HVAC or plumbing shop.
          </p>
          <button
