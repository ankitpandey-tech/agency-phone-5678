...
export default function DemoView({ setCurrentPage }: DemoViewProps) {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Replacing or augmenting standard live phone staff with NeviqAI reduces your cost-per-minute of reception from $1.50+ to just pennies. Save thousands per month.",
    ...
    },
    {
      ...
      description: "While on the line or immediately after a call, the AI sends SMS confirmations, custom booking links, address directions, or quote estimate forms automatically.",
  ...
  const faqs = [
    {
      question: "How does NeviqAI actually answer my business phone calls?",
      answer: "We provide you with a dedicated local or toll-free phone number, or you can instantly set up conditional call-forwarding from your existing phone system (e.g. forward only when busy, unanswered, or after-hours) so calls route directly to your NeviqAI receptionist."
    },
    {
    ...
    {
      question: "How does NeviqAI handle spam calls, robocalls, or wrong numbers?",
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4" id="demo-page-header">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-black tracking-tight text-slate-900 leading-none">
            Experience NeviqAI <span className="text-blue-600">AI</span>
          </h1>
          ...
          <div className="bg-slate-900 rounded-3xl p-3 md:p-4 shadow-2xl border border-slate-800 relative group overflow-hidden">
            ...
            <div className="aspect-video w-full rounded-2xl overflow-hidden bg-black relative shadow-inner mt-3">
              <iframe
                ...
                title="NeviqAI Receptionist Demo Video"
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-8">
            <div className="space-y-2 max-w-lg">
              ...
              <p className="text-slate-600 text-xs md:text-sm">
                Everything you need to know about integrating NeviqAI into your local home service or retail shop.
              </p>
            </div>
            <button
        ...
        <div className="bg-slate-900 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden shadow-2xl border border-slate-800" id="demo-page-footer-cta">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-slate-400 text-xs md:text-sm md:text-base leading-relaxed max-w-lg mx-auto">
              Get a custom demo number pre-loaded with your business pricing, FAQ, and calendar in under 24 hours. Call it yourself and see why local business owners are moving to NeviqAI.
            </p>
