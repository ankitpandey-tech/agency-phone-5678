...
export default function HomeView({ setCurrentPage }: HomeViewProps) {
  ...
  const [activeIndustryTab, setActiveIndustryTab] = useState<string>('hvac');
  ...
  const [calculatorNiche, setCalculatorNiche] = useState<string>('hvac');
  ...
  const [demoIndustry, setDemoIndustry] = useState<string>('HVAC');
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome-msg-1',
      role: 'assistant',
      text: "Thanks for calling Arctic Breeze HVAC. This is your virtual receptionist. How can I assist you today?",
      timestamp: new Date()
    }
  ]);
    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (!updatedLead.serviceRequested) {
          if (textLower.includes("cleaning") || textLower.includes("hvac")) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes. NeviqAI fully integrates with Google Calendar, Calendly, and leading CRM tools. It checks live availability in real-time and inserts the reservation instantly without double-booking."
    },
    {
      q: "How does the Google Review Automation work?",
      a: "Once a service booking is completed in your list, NeviqAI automatically dispatches an elegant SMS containing a direct Google Review link. By requesting reviews in the 'golden' hour after service, we boost service reviews by over 300% on average."
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-6" id="hero-left-col">
            ...
            <p className="font-sans font-normal text-slate-600 text-base md:text-lg leading-relaxed max-w-2xl">
              NeviqAI is the absolute easiest way for local practices and service companies to eliminate missed calls. We don't just sell you software—our elite telephony engineers build, host, and tune your custom voice assistant so it books appointments directly into your business calendar perfectly.
            </p>
            ...
            <div className="bg-slate-50 border border-slate-200/60 p-4 rounded-2xl text-xs space-y-1.5 text-slate-600 max-w-xl">
              <div className="font-bold text-slate-800 flex items-center space-x-1.5 font-mono uppercase tracking-wider text-[10px]">
                ...
                <span>The NeviqAI Hybrid Pledge:</span>
              </div>
            ...
            <div className="relative w-full max-w-sm bg-slate-900 text-white rounded-[3rem] p-4 shadow-2xl border-4 border-slate-800 shadow-blue-900/10">
              ...
              <div className="bg-slate-950 rounded-[2.5rem] p-6 h-[480px] flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="flex justify-between items-center text-[10px] text-slate-400 font-mono">
                  <span>NeviqAI Integration Hub</span>
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-6 md:p-8 flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-900/60 border border-slate-850 p-4 rounded-2xl space-y-2 text-xs">
                    ...
                    <div className="flex justify-between text-green-400 pt-1 font-semibold">
                      <span>Monthly Recaptured Revenue with NeviqAI:</span>
              ...
              <div className="space-y-3 pt-6">
                <p className="text-[10px] text-slate-500 italic leading-relaxed">
                  * Assumes NeviqAI pick-up rate of 100% and a conservation of 85% of standard user booking intent via smart verbal logic & text callbacks.
                </p>
      ...
      <section className="bg-slate-950 text-white py-20 border-b border-slate-900" id="how-it-works-section">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-white">How NeviqAI Operates</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6 relative" id="how-it-works-grid">
            ...
            <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 text-center flex flex-col space-y-3 items-center group relative hover:border-blue-500/50 transition-all">
              ...
              <p className="text-slate-400 text-xs leading-relaxed">
                Auto-sends the customer a clear SMS confirmation map link.
              </p>
            </div>
      ...
      <section className="bg-slate-900 text-white py-20 border-b border-white/5 relative" id="live-receptionist-demo-section">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6" id="demo-widget-left-col">
            ...
            <p className="text-slate-400 text-base leading-relaxed">
              Select your local business industry using the selector. Send custom testing scripts to check how the Express AI Receptionist instantly answers queries, catalogs customer details, and auto-structures calendars.
            </p>
              ...
              <div className="flex-1 flex flex-col h-full bg-slate-900/30">
                ...
                <form onSubmit={handleSendMessage} className="p-3 bg-slate-950 border-t border-slate-800 flex items-center space-x-2">
                  <input
                    ...
                    placeholder="Type caller response (e.g. 'Yes schedule AC repair...')"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="premium-features-row">
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-md hover:-translate-y-1 duration-200 transition-all group flex flex-col justify-between">
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed mt-2.5">
                  Boost SEO parameters automatically. We message high-starred text links right after field visits, improving your Local Maps ranking on autopilot.
                </p>
              </div>
              <span className="text-xs font-extrabold text-blue-600 hover:underline inline-flex items-center space-x-1.5 pt-4 cursor-pointer" onClick={() => setCurrentPage('solutions')}>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-md hover:-translate-y-1 duration-200 transition-all group flex flex-col justify-between">
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed mt-2.5">
                  Expand lead channels with active digital chat. NeviqAI manages WhatsApp client inquiries with the exact same system parameters.
                </p>
              </div>
              <span className="text-xs font-extrabold text-blue-600 hover:underline inline-flex items-center space-x-1.5 pt-4 cursor-pointer" onClick={() => setCurrentPage('solutions')}>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-md hover:-translate-y-1 duration-200 transition-all group flex flex-col justify-between">
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed mt-2.5">
                  Integrates directly with Zapier, n8n, OpenPhone, and default service CRM, keeping lead parameter statuses matching across multiple branches.
                </p>
              </div>
              <span className="text-xs font-extrabold text-blue-600 hover:underline inline-flex items-center space-x-1.5 pt-4 cursor-pointer" onClick={() => setCurrentPage('solutions')}>
            ...
            <div className="bg-slate-950 rounded-2xl p-6 text-white space-y-4 shadow-xl border border-slate-900" id="tab-visual-mimic-panel">
              ...
              <div className="space-y-3 font-mono text-xs text-slate-350">
                <p className="text-slate-400">
                  <span className="text-blue-400 font-bold">AI Receiver:</span> "Hello! Thanks for ringing our dispatch desk. Our system is fully fully secure. Looking to book your appointment slot?"
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm" id="testimonials-row">
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-250/50 flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <p className="text-slate-650 italic leading-relaxed">
                  "Our plumbing business receives massive emergency calls late at night. The AI takes everything in stride. It schedules dispatch slots flawlessly on Saturday nights, and texts arrival times automatically. Absolute gamechanger!"
                </p>
              </div>
              <div className="flex items-center space-x-3 pt-6 border-t border-slate-200/50 mt-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500">Master Electrician & Owner, VoltGuard Electrical</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-250/50 flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <p className="text-slate-650 italic leading-relaxed">
                  "We underwrote Google search ads for years but missed half the leads from mechanics being out on the shop floor. Setting up NeviqAI changed everything. We've recovered 28 oil changes value in our first 15 days of activation."
                </p>
              </div>
              <div className="flex items-center space-x-3 pt-6 border-t border-slate-200/50 mt-6">
                <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center font-bold text-blue-700">
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-250/50 flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <p className="text-slate-650 italic leading-relaxed">
                  "The Google Review Automation is like magic. Client gets their AC fixed, AI sends feedback SMS 45 minutes after service complete, and we’ve spiked from 82 reviews to 350+ in under three months. Our SEO rankings took off!"
                </p>
              </div>
              <div className="flex items-center space-x-3 pt-6 border-t border-slate-200/50 mt-6">
                <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center font-bold text-blue-700">
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-12">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-650 text-sm max-w-2xl mx-auto leading-relaxed">
              Explore the core architectural rules of NeviqAI to understand how we optimize your local business scheduling.
            </p>
          </div>
